...
model_dir_s1 = (
    "./outputs_tutorial_7/training_s1"  # folder where the models will be saved
)


training_s1(
    labels_dir=labels_dir_s1,
...
training_d(
    list_paths_input_labels=list_input_labels,
...
model_dir_s2 = (
    "./outputs_tutorial_7/training_s2"  # folder where the models will be saved
)

training_s2(
    labels_dir=labels_dir_s2,
