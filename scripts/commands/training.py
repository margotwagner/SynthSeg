...
parser.add_argument(
    "--generation_labels", type=str, dest="generation_labels", default=None
)
parser.add_argument("--neutral_labels", type=int, dest="n_neutral_labels", default=None)
parser.add_argument(
    "--segmentation_labels", type=str, dest="segmentation_labels", default=None
)
...
parser.add_argument(
    "--generation_classes", type=str, dest="generation_classes", default=None
)
parser.add_argument(
    "--prior_type", type=str, dest="prior_distributions", default="uniform"
)
...
parser.add_argument(
    "--specific_stats", action="store_true", dest="use_specific_stats_for_channel"
)
parser.add_argument(
    "--mix_prior_and_random", action="store_true", dest="mix_prior_and_random"
)
...
parser.add_argument("--shearing", dest="shearing_bounds", type=infer, default=0.012)
parser.add_argument(
    "--translation", dest="translation_bounds", type=infer, default=False
)
parser.add_argument("--nonlin_std", type=float, dest="nonlin_std", default=4.0)
parser.add_argument("--nonlin_scale", type=float, dest="nonlin_scale", default=0.04)

# blurring/resampling parameters
parser.add_argument("--randomise_res", action="store_true", dest="randomise_res")
parser.add_argument("--max_res_iso", type=float, dest="max_res_iso", default=4.0)
parser.add_argument("--max_res_aniso", type=float, dest="max_res_aniso", default=8.0)
...
parser.add_argument("--bias_scale", type=float, dest="bias_scale", default=0.025)
...
parser.add_argument(
    "--steps_per_epoch", type=int, dest="steps_per_epoch", default=10000
)
