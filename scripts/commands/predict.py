...
parser.add_argument(
    "path_images",
    type=str,
    help="path single image or path of the folders with training labels",
)
...
parser.add_argument(
    "--post",
    type=str,
    dest="path_posteriors",
    default=None,
    help="posteriors folder/path",
)
parser.add_argument(
    "--resampled",
    type=str,
...
parser.add_argument(
    "--vol", type=str, dest="path_volumes", default=None, help="path volume file"
)

# Processing parameters
parser.add_argument(
    "--min_pad", type=int, dest="min_pad", default=None, help="margin of the padding"
)
parser.add_argument(
    "--cropping",
    type=int,
...
parser.add_argument(
    ...
    dest="conv_size",
    default=3,
    help="size of unet convolution masks",
)
parser.add_argument(
    "--n_levels", type=int, dest="n_levels", default=5, help="number of levels for unet"
)
parser.add_argument(
    "--conv_per_level",
    type=int,
